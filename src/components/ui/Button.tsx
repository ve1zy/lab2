...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-button-1 text-button-1 hover:bg-[#a00003] active:bg-[#900002] focus:ring-button-1',
    secondary: 'bg-gray-200 text-gray-800 hover:bg-gray-300 active:bg-gray-400 focus:ring-gray-300',
    outline: 'border border-button-1 text-button-1 bg-transparent hover:bg-button-1 hover:text-button-1 active:bg-[#a00003] focus:ring-button-1',
    ghost: 'text-button-1 bg-transparent hover:bg-gray-100 active:bg-gray-200 focus:ring-gray-300',
